...
public class HOME extends javax.swing.JFrame {
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(Deletedbtn, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
                        .addGap(94, 94, 94)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(Externalloginbtn, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
            ...
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                    ...
                    .addComponent(ProcessUserActivityScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 467, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addContainerGap()))
        );
    ...
    private void list_event_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_list_event_btnActionPerformed
        ...
        int SecEventCount=0;
    String query="SELECT id,userid,emprole,group_id,employeeId,emailaddress,userfullname,logindatetime+interval 3 HOUR as logindatetime,empipaddress FROM SENTRIFUGO.main_userloginlog order by logindatetime desc;";
       ...
       for( int i = UserActivityTbl.getModel().getRowCount() - 1; i >= 0; i-- )
        {
            ...
            String SecUserLoginLog = "INSERT INTO [useractivitylog] (menu,last_modified_by,last_modified_date,employeeid,action,record,recordid) VALUES ('"+menu+"','"+last_modified_by+"','"+last_modified_date+"','"+employeeid+"','"+action+"','"+record+"','"+id+"')";
            consql.update(SecUserLoginLog);
            SecEventCount++;
    ...
    private void ListUserActivityBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ListUserActivityBtnActionPerformed
        ...
        int SecEventCount=0;
    String query="SELECT * FROM SIEMCONVERTBU UNION SELECT * FROM SIEMCONVERTDEPT union SELECT * FROM SIEMCONVERTJT UNION SELECT * FROM SIEMCONVERTPS UNION SELECT * FROM SIEMCONVERTEREMPS ORDER BY LASTMODIFIEDDATE DESC";
    rs=conMysql.retrieve(query);
      try
        {
        while (rs.next())
        {
            ...
            ((DefaultTableModel)UserActivityTbl.getModel()).addRow(new Object[]{menu,modifiedby,employeeid,action,lastdatemodified,record,id});
            SecEventCount++;
        }
        JOptionPane.showMessageDialog(null,"We have found "+SecEventCount+" Events","COMPLETE" , JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private void ProcessUserActivityTbl1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ProcessUserActivityTbl1MouseClicked
        if (checkact==1)
        {
        ...
        if (ProcessUserActivityTbl1.getSelectedRow() > -1) {
         ...
         int SecEventCount=0;
    String queryactivity="SELECT * FROM [SIEM_CONVERTER].[DBO].[useractivitylog] where [employeeid]='"+EMPid+"' AND [last_modified_date] > '"+EventDate+"'";
    ...
    try
        ...
        while (rs.next())
        {
            ...
            String record=rs.getString("record");
             ...
             final IMessageTransmitter kiwiMessageTransmitter = new KiwiMessageTransmitterImpl_1();
             kiwiMessageTransmitter.send("Table="+menu+":LastModifiedBy="+last_modified_by+":LastModifiedDate="+last_modified_date+":EmployeeID="+employee_id+":ActionPerformed="+action+":Record="+record);  
           
            SecEventCount++;
        }
        JOptionPane.showMessageDialog(null,"We have sent "+SecEventCount+" Deleted Activity Events to SysLog Server for Employee ID "+EMPid+" ","COMPLETE" , JOptionPane.INFORMATION_MESSAGE);
        }
        catch(SQLException w)
        {
            JOptionPane.showMessageDialog(null,w.getMessage()," NO RECORD FOUND ",JOptionPane.ERROR_MESSAGE);
        ...
        if (ProcessUserActivityTbl1.getSelectedRow() > -1) {
         ...
         int SecEventCount=0;
    String queryactivity="SELECT * FROM [SIEM_CONVERTER].[DBO].[useractivitylog] where [recordid]='"+recid+"' AND [last_modified_date] >= '"+EventDate+"'";
    ...
    try
        ...
        JOptionPane.showMessageDialog(null,"We have sent "+SecEventCount+" deleted records to SysLog Server ","COMPLETE" , JOptionPane.INFORMATION_MESSAGE);
        }
        catch(SQLException w)
        {
            JOptionPane.showMessageDialog(null,w.getMessage()," NO RECORD FOUND ",JOptionPane.ERROR_MESSAGE);
    ...
    }//GEN-LAST:event_ProcessUserActivityTbl1MouseClicked

    private void ProcessUserActivityTbl1FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_ProcessUserActivityTbl1FocusGained
      
    }//GEN-LAST:event_ProcessUserActivityTbl1FocusGained
